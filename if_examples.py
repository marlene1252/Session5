# let's create a virtual bartender that serves you if you are legal age

from random import choice
drinks = ["whiskey", "rum", "tequila", "gin", "vodka"]
mixers = ["fanta", "red bull", "tonic", "cola", "soda"]
...
try:
    ...
    legal = None
    country = input("Where are you fom? ")
    if age < 14:
        legal = False
    elif age < 16 :
        if country == "Austria":
